...
**How to apply:** Keep call endpoints restricted to the two participants, clean up signaling data when calls end, and add a TURN service before relying on this for users behind restrictive NATs or firewalls.