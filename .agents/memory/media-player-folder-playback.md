...
During a folder-scoped run, the player artwork should use the folder’s cover image for every track, even when individual tracks have their own artwork. Removing the active folder or its last remaining item must clear the playback context.
